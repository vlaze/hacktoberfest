...
if ( null==$Code ) {
	...
	$sql3="SELECT DISTINCT Formats.Format, Audio, Subtitles, FormatCode, AudioLang, SeasonNum, VolumeNum, DiscNum, Location, EpPerDisc, Extra, DiscTitle, Note FROM Formats, MediaInfo, AudioLangs WHERE  MediaInfo.FormatCode=Formats.Code AND MediaInfo.AudioLang=AudioLangs.Code AND MediaInfo.MovieCode = ?";
	$q = $pdo->prepare($sql);
